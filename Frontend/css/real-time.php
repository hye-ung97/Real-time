	...
	<head>
        ...
        $(function() {
            ...
            function RollingText(P, N, idx)
            {
                ...
                $(Prev).delay(2000).animate({top: "-=33px"}, 1000, function(){
                });
                $(Next).delay(2000).animate({top: "-=33px"}, 1000, function(){
        ...
        $(function() {
            ...
            function RollingText2(P, N, idx)
            {
                ...
                $(Prev2).delay(2000).animate({top: "-=33px"}, 1000, function(){
                });
                $(Next2).delay(2000).animate({top: "-=33px"}, 1000, function(){
        ...
        $(function() {
            ...
            function RollingText3(P, N, idx)
            {
                ...
                $(Prev3).delay(2000).animate({top: "-=33px"}, 1000, function(){
                });
                $(Next3).delay(2000).animate({top: "-=33px"}, 1000, function(){
				...
				<div class="row">				
					...
					<div id="content" class="12u skel-cell-important">
						<section>
							<header>
								<h2>Real - Time</h2>
                                <span class="byline">NAVER DAUM NATE's REAL TIME</span>
                            </header>
                                ...
                                <section>       
                                    ...
                                    <?php
                                        ...
                                        if($cnt == 0 && $reWord !=NULL){
                                            echo '<div> 최근 한달동안 실시간 검색어에 오른 날이 없습니다. </div>';
                                        }
                                        else{
                                            while($row = mysqli_fetch_array($result)){
                                                echo '<div class="reword"> <a href="'.$sn.$row["yeon"].'" target="_blank" > #'.$row["yeon"].' </a></div>';
                ...
                <div class="row">				
					...
					<div id="content" class="12u skel-cell-important">
						<section>
                            ...
                            <div style="padding-top: 3%;"> 
                                <section>       
                                    <div class="relate"> <?php echo $reWord2 ?></div>
                                    <?php
                                        $sql = "select yeon from relation where contents = '".$reWord2."' order by date limit 5";
                                        $result = mysqli_query($conn, $sql);
                                        while($row = mysqli_fetch_array($result)){
                                            echo '<div class="reword"> <a href="https://www.google.com/search?q='.$row["yeon"].'" target="_blank" > #'.$row["yeon"].' </a></div>';
                                        }
                                    ?>
                                    <div style="clear:both;"></div>
                                </section>
