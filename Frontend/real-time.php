...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" ){     
        ...
        if($_POST["nkeyword"]!=NULL)   {
            ...
            $site = "naver";
            echo "<script>location.href='https://capruby07.cafe24.com/capstone2/real-time.php#catBlock';</script>";
        }
        ...
        if($_POST["keyword2"]!=NULL)   {
            ...
            $sDate = $_SESSION["sDate"];
            $eDate = $_SESSION["eDate"];
            echo "<script>location.href='https://capruby07.cafe24.com/capstone2/real-time.php#catBlock2';</script>";
        }
                            ...
                            <div style="padding-top: 3%;"> 
                                <section>       
                                    ...
                                    <div>
                                        <?php 
                                            if($reWord !=NULL){
                                                $sql = 'select * from '.$site.' where contents = "'.$reWord.'" order by time desc';      
                                                $result = mysqli_query($conn, $sql);
                                                $i=0;
                                                $d =[];
