...
body .container .content input.distinct {
  font-size: 12px;
  line-height: 42px;
  display: inline;
  width: 20%;
...
body .container .content input.distinct:hover {
...
<section class="container">
          <article class="half">
                ...
                <form action="Register.php" method="post" enctype="multipart/form-data">
                                      <th>
                                      <input type="text" name="id" id="ID" class="inpt2" required="required" placeholder="Your Id">
                                      <label for="text">Your Id</label>
                                      <input type="button" value="중복확인" id="checkid" class="distinct" onclick="return validation()"/></th>
                                      <input type="password" name="password" id="PASSWORD" class="inpt" required="required" placeholder="Your Password">
                                      <label for="password">Your Password</label>
...
<script type="text/javascript">
  ...
  i=0;
  //var arraa = <?php echo json_encode($row["id"])?>;
  var kkksd = <?php echo json_encode($k)?>;
  var sss = <?php echo json_encode($count)?>;
